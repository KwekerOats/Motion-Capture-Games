...
def pong_game():
    ...
    class pong:
        ...
        def countdown(self):
        	...
        	number = font.render('3', True, (255, 0, 255), (0, 0, 0))
        	numloc = number.get_rect()
        	numloc.centerx = self.screen.get_rect().centerx
        	numloc.centery = self.screen.get_rect().centery
        	self.screen.blit(number, numloc)
        	pygame.display.flip()
        	time.sleep(1)
        	font = pygame.font.SysFont(None, 48)
        	number = font.render('2', True, (0, 255, 255), (0, 0, 0))
        	self.screen.blit(number, numloc)
        	pygame.display.flip()
        	time.sleep(1)
        	font = pygame.font.SysFont(None, 48)
        	number = font.render('1', True, (255, 255, 0), (0, 0, 0))
        	self.screen.blit(number, numloc)
        	pygame.display.flip()
        	time.sleep(1)
        ...
        def game_info(self):
        	...
        	p1gi = basicfont.render(str(self.p2_score), True, (255, 255, 255), (0, 0, 0))
        	p1gir = p1gi.get_rect()
        	p1gir.centerx = 30
        	p1gir.centery = 30
        ...
        def game_loop(self):      
            ...
            #main game loop for pong without gyro
            while True:
